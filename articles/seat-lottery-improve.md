...
赤、緑、青、黒、そして背景の白･･･。工業デザイン的には、使う色は背景色 + 文字色 + アクセントカラー (1 or 2) で計 3色、最大でも 4色程度までが限度です。
...
![新版 v2 UI](/images/seat-lottery-improve/newv2-ui.webp)

これまで座席タイプを文字で表現していたところをアイコンにしました。文字だらけで騒がしかった UI を、アイコンを用いることでおとなしく、かつ必要な情報は保つことができました。
